//! The remaining dark wells: the filter response and the small NOTE / VELO curve
//! boxes in the voicing panel. The LFO well is its own editor, in [`super::lfo_editor`].
//!
